...
CREATE DEFINER=`cs340_cuneob`@`%` PROCEDURE `dropItem` (IN `itemN` VARCHAR(255), IN `save` INT, IN `worldID` INT)  MODIFIES SQL DATA
BEGIN
...
CREATE DEFINER=`cs340_cuneob`@`%` PROCEDURE `goVia` (IN `path` VARCHAR(255), IN `save` INT, IN `worldID` INT)  NO SQL
BEGIN
...
CREATE DEFINER=`cs340_cuneob`@`%` PROCEDURE `lookAt` (IN `thing` VARCHAR(255), IN `save` INT, IN `worldID` INT)  NO SQL
BEGIN
...
CREATE DEFINER=`cs340_cuneob`@`%` PROCEDURE `pickUp` (IN `item` VARCHAR(255), IN `save` INT, IN `worldID` INT)  NO SQL
BEGIN
...
CREATE DEFINER=`cs340_cuneob`@`%` PROCEDURE `showInventory` (IN `save` INT, IN `world` INT)  NO SQL
BEGIN
...
CREATE DEFINER=`cs340_cuneob`@`%` PROCEDURE `showLocation` (IN `save` INT, IN `world` INT)  NO SQL
BEGIN
